/**
 * SQL Migration: Create tables in Supabase
 * 
 * Run this once to initialize the database schema.
 * You can also copy-paste the SQL into the Supabase Query Editor.
 */
...
-- ============================================================
--  PLANT IMAGES TABLE
--  Stores captured images of each plant (base64 or URL)
-- ============================================================
...
--  Uncomment if you want to restrict data access
-- ============================================================

-- ALTER TABLE public.sensor_readings ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.plant_images ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.plant_detections ENABLE ROW LEVEL SECURITY;
`;
